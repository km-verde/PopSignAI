...
public class mainscript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (LevelData.LimitAmount <= 0 && !gotAStar && GamePlay.Instance.GameStatus == GameState.Playing && newBall == null)
        {
            Debug.Log("Game Win 2");
        ...
        else if (Balls.childCount == 0 && GamePlay.Instance.GameStatus == GameState.Playing)
        {
            GamePlay.Instance.GameStatus = GameState.Win;
            score = 0;
            _ComboCount = 0;
